...
<?php if(isset($_SESSION['user_id']) && intval($_SESSION['user_id']) > 0 && $_SESSION['check_url'] == "post-game-verification") { ?>
...
<body class="end-quiz">
  ...
  <div id="end" class="container-quick-quiz flex-center flex-column">
      ...
      <form action="game-ending" method="post" class="fs-400 ff-sans-cond letter-spacing-3 uppercase">
      ...
      if(changes){
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.isConfirmed) {
            <?php $_SESSION['check_url'] = "post-game-verification"; ?>
