...
<body class="about">
  ...
  <main id="main" class="grid-container grid-container--about flow">
    ...
    <article class="about-details flow" id="game-tab" role="tabpanel" tabindex="0">
      ...
      <p>In Our Red Stilettos follows the consecutive, intertwined stories of Amanda, Salomé, Shinobu,
        and Willow as they navigate their way through adulthood and strive to climb the corporate
        ladder.
        <br><br>
