...
<ul id="primary-navigation" data-visible="false" class="primary-navigation underline-indicators flex">
    ...
    <li class="<?php echo $page=='characters.php' ? 'active' : ''; ?>"><a class="ff-sans-cond uppercase text-white letter-spacing-2" href="characters"><span aria-hidden="true">01</span>Characters</a>
    ...
    <li class="<?php echo $page=='about.php' ? 'active' : ''; ?>"><a class="ff-sans-cond uppercase text-white letter-spacing-2" href="about"><span aria-hidden="true">03</span>About</a>
