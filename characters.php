...
<body class="characters">
  ...
  <main id="main" class="grid-container grid-container--characters flow">
    ...
    <article hidden class="characters-info flow" id="asian-tab" tabindex="0"  role="tabpanel">
      ...
      <p>Having been raised in a relatively homogenous society and trying to make it big on the
        opposite side of the world where the population is as heterogenous as it can get, Graphic
